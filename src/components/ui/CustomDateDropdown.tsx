    ...
    return (
        <div className="relative z-50">
            ...
            >
                ...
                <PrevIcon
                    className={`h-6 w-6 shrink-0 transition-transform duration-300 ${isOpen ? "rotate-90" : "-rotate-90"}`}
                />
            </button>

            {isOpen && (
                <div
                    className="absolute left-1/2 top-full z-[9999] mt-2 w-[300px] -translate-x-1/2 rounded-2xl border border-cyan-400/30
                ...
                >
                    ...
                    <div className="mb-2 grid grid-cols-7 gap-1">
                        {MINI_CALENDAR_VIEWS.map((day) => (
                            <div
                                key={day}
                                className="flex h-1 items-center justify-center text-xs font-semibold text-cyan-300"
                            >
                                {day}
                            </div>
                        ))}
