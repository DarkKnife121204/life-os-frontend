...
export default function ProfileMenu() {
    ...
    return (
        <div
            className="absolute right-0 top-14 z-50 w-[calc(100vw-2rem)] max-w-[320px] rounded-xl border border-purple-500/70 bg-[#020b12]/95 backdrop-blur-xl
            shadow-[0_0_30px_rgba(168,85,247,0.35)] p-4 md:p-5"
        >
            <div className="flex items-center gap-4 mb-5">
                <div
                    className="h-10 w-10 shrink-0 rounded-full border border-cyan-400 flex items-center justify-center text-cyan-300 text-xl
                ...
                <div className="min-w-0">
                    <p className="text-xl font-[Orbitron] text-white">{user?.name}</p>
