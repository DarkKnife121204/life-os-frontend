            ...
            >
                ...
                <div className="relative flex h-full flex-col overflow-y-auto px-3 py-3 md:py-4">
                    <Link
                        ...
                        className="mb-5 md:mb-7 h-11 shrink-0 flex items-center rounded-xl text-cyan-400 w-min overflow-hidden"
                    >
                        <div
                            className={`h-10 rounded-xl border border-cyan-400/30 bg-cyan-400/5 flex items-center overflow-hidden shadow-[0_0_14px_rgba(0,255,255,0.18)]
                        ...
                        >
                            ...
                            <span
                                className={`text-xl font-bold [text-shadow:0_0_10px_rgba(0,255,255,0.8)] transition-all duration-400
                        ...
                        {menu.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`whitespace-nowrap text-lg overflow-hidden transition-all duration-400 
                    ...
                    <div className="mt-auto mb-3 h-px shrink-0 w-full bg-cyan-400/10 shadow-[0_0_12px_rgba(0,255,255,0.12)]" />
