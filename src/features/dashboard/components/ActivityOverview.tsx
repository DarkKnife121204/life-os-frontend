    ...
    return (
        <Card className="min-h-[280px] p-4 md:p-5 xl:p-6 xl:col-span-2">
            <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <h2 className="text-xl leading-tight">Activity Overview</h2>
                ...
                <div className="relative w-full sm:w-auto">
                    ...
                    >
                        ...
                        <PrevIcon
                            className={`h-6 w-6 transition-transform duration-300 ${isPeriodOpen ? "rotate-90" : "-rotate-90"}`}
                        />
                    </button>

                    {isPeriodOpen && (
                        <div
                            className="absolute right-0 top-12 z-50 w-full sm:w-40 rounded-xl border border-cyan-400/30 bg-[#06121a]/95
