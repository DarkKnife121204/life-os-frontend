...
export default function QuickAdd() {
    return (
        <Card className="min-h-[260px] p-4 md:p-5 xl:p-6">
            <h2 className="mb-4 text-xl leading-tight">Quick Add</h2>
            ...
            <button
                className="mt-4 flex h-12 md:h-14 w-full cursor-pointer items-center justify-center gap-4 rounded-xl bg-cyan-400 text-sm md:text-base text-slate-950
