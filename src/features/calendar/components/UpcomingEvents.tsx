                ...
                {upcomingEvents.map((event) => {
                    ...
                    return (
                        <div key={event.id} className="flex items-center gap-3">
                            <div
                                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg ${BG_COLOR_CLASSES[event.color]}  ${TEXT_COLOR_CLASSES[event.color]}`}
                            >
                            ...
                            <span
                                className={`shrink-0 rounded-md px-2 py-1 text-[10px] ${BG_COLOR_CLASSES[event.color]}  ${TEXT_COLOR_CLASSES[event.color]}`}
                            >
                                {event.type}
                            </span>
                        </div>
