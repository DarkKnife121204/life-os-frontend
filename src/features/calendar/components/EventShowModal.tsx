                ...
                <>
                    ...
                    <div className={`mt-4 grid grid-cols-1 gap-4 ${event.status === "Upcoming" ? "md:grid-cols-3" : "md:grid-cols-2"}`}>
                        ...
                        {event.status === "Cancelled" ? (
                            <Button variant="success" onClick={() => handleAction(restoreEvent)} className="flex items-center justify-center gap-2 py-4">
                            ...
                            <>
                                {event.status === "Upcoming" ? (
                                    <Button variant="success" onClick={() => handleAction(completeEvent)} className="flex items-center justify-center gap-2 py-4">
                                        <CompleteIcon className="h-5 w-5" />
                                        Complete
                                    </Button>
                                ) : null}
                                <Button variant="danger" onClick={() => handleAction(deleteEvent)} className="flex items-center justify-center gap-2 py-4">
