...
export default function MiniCalendar() {
    ...
    const handlePrev = () => {
        setMiniDate((prevDate) => getPrevMonth(prevDate));
    };
    const handleNext = () => {
        setMiniDate((prevDate) => getNextMonth(prevDate));
    };
        ...
        <Card className="p-4">
            <div className="mb-5 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        onClick={handlePrev}
                        className="flex items-center justify-center h-8 w-8 cursor-pointer  rounded-lg border border-cyan-400/15 bg-[#030D14]
