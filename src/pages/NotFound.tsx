        ...
        >
            <div className="relative flex flex-col items-center text-center">
                ...
                <div className="relative mb-8 opacity-80">
                    <div
                        className="w-36 h-32 rounded-xl border border-cyan-200/20 bg-slate-900/40 backdrop-blur-md rotate-[8deg]
                    ...
                    >
                        ...
                        <div className="text-4xl text-cyan-100/50">⌒</div>
                ...
                <h1
                    className="relative text-[120px] leading-none font-black tracking-widest bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500
                ...
                <h2 className="mt-6 text-3xl font-semibold tracking-wide text-white">Page not found</h2>
